...
int main()
{
	...
	srcImage_base = imread("F:\\opencv\\images\\9.3.jpg", 1);
	srcImage_test1 = imread("F:\\opencv\\images\\9.2.jpg", 1);
	srcImage_test2 = imread("F:\\opencv\\images\\9.1.jpg", 1);
	...
	for (int i = 0; i < 4; i++)
	{
		...
		printf("方法[%d]的匹配结果如下：\n\n【基准图-基准图】:%f，【基准图-半身图】:%f，【基准图-测试图1】:%f，【基准图-测试图2】:%f\n-------------------------------------------------------------------------\
			n", i, base_base, base_half, base_test1, base_test2);
	}
